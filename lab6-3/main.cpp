...
#define PIN1_TOG    {pin1 = !pin1;}
#define PIN2_TOG    {pin2 = !pin2;}
...
// void target_audio_buffer_full() {
    ...
    // printf("Total complete events: %lu, index is %lu\n", (unsigned long)transfer_complete_events, (unsigned long)TARGET_AUDIO_BUFFER_IX);
